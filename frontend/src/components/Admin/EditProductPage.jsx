...
const EditProductPage = () => {
    ...
    return (
        <div className='max-w-5xl mx-auto p-6 shadow-md rounded-md'>
            ...
            sizes */}
                <div className="mb-6">
                    <label className='block font-semibold mb-2'>Sizes (comma-separed)</label>
                ...
                {/* colors */}
                <div className="mb-6">
                    <label className='block font-semibold mb-2'>Colors (comma-separed)</label>
                ...
                {/* Image upload */}
                <div className="mb-6">
                    <label className='block font-semibold mb-2   px-2 py-1 '>
                        Upload Imagae
                    </label>
                    ...
                    <div className="flex gap-4 mt-4">
                        {productData.images.map((image, index) => (
                            <tr key={index}>
                                <img src={image.url} alt={image.altText || "Product Image"} className='w-20 h-20 object-cover rounded-md shadow' />
                            </tr>
                        ))}
                    </div>
                </div>
