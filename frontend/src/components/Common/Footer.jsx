...
const Footer = () => {
  return (
    <footer className='border-top py-12 border-t-2 border-gray-100'>
        <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-8 '>
            <div>
                ...
                <form action="" className='flex'>
                    <input type="email" name="" id="" placeholder='Email' className='p-3 w-full text-sm border-t border-l border-b border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all'/>
        ...
        {/* Footer Bottom */}
        <div className='container mx-automt-12 px-4 lg:px-0 border-t border-gray-200 pt-6'>
            <p className='text-gray-500 text-sm tracking-tight text-center'>
                &copy; Made by Dhanush
            </p>
