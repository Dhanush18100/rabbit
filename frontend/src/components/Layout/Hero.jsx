...
const Hero = () => {
  return (
    <section className="relative">
        <img src={heroImg} alt="Rabit" className="w-full h-[400px] md:h-[600px] lg:h-[750px] object-cover" />
        <div className="absolute inset-0  bg-opacity-5 flex items-center justify-center">
            <div className="text-center text-white p-6">
                ...
                <Link to="#" className="bg-white text-gray-950 px-6 py-2 rounded-sm tect-lg">
                Shop Now
                </Link>
            </div>
